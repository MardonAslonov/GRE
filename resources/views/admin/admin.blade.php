    ...
    <header class="bg-dark py-1">
        <div class="container px-4 px-lg-3 my-2">
            <div class="text-center text-white">
                <h3 class="display-7 fw-bolder">Admin panel</h3>
                <p class="lead fw-normal text-white-50 mb-0">variant CRUD va statistika</p>
            </div>
        </div>
    </header>
    <!-- Section-->
    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-center row">
            ...
            <div class="col-md-5 col-lg-4">
                ...
                <br>
                <div class="d-grid gap-2 col-8 mx-auto">
                    <a class="btn btn-outline-success" href="testCreatePage" role="button">Savol qo'shish
                        <i class="bi bi-file-check-fill"></i>
                    </a>
                </div>
                <br><br>
