            ...
            <div class="col-md-5 col-lg-4">
                <div class="border">
                    <table class="table table-sm">
                        <thead>
                            <tr>
                                <th scope="col" colspan="4" class="text-center">To'g'ri javoblar</th>
                            </tr>
                            <tr>
                                <th scope="col">№</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($tests as $test)
                                <tr>
                                    <th scope="row">{{ ($tests->currentpage() - 1) * 10 + $a++ }}</th>
                                    <td>{{ $test->nameImage }}</td>
                                    <td>{{ $test->answer }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                ...
                <br>
                {{ $tests->appends(['variantId' => $variantId])->links() }}
            </div>
        </div>
    </div>
    <br><br>
